...
@section('content')
    <div class="form-wrapper">
        <div class="form-header">
            <div class="form-info">
                <h3 class="form-title">Edit Course FAQ</h3>
        ...
        <div class="form-body">
            <form action="{{ route('course-faq.update', $faq->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Answer</label>
                            <textarea class="form-control" name="answer" rows="4" placeholder="Enter FAQ Answer">{{ old('answer', $faq->answer) }}</textarea>
                            @error('answer')
                                <small class="error-text">{{ $message }}</small>
                            @enderror
                        </div>
