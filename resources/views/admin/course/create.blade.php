                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="video" class="form-control @error('video') is-invalid @enderror"
                                value="{{ old('video') }}" placeholder="Enter Video URL">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="drive" class="form-control @error('drive') is-invalid @enderror"
                                value="{{ old('drive') }}" placeholder="Enter Drive Link">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="total_seat"
                                ...
                                value="{{ old('total_seat') }}" placeholder="Total Seat">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="offer_start"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="offer_end"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="thumbnail"
                                class="dropify @error('thumbnail') is-invalid @enderror" data-height="100"
